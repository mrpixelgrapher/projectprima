...
- Policy this executes: `lrp6-content-infrastructure/01 - research-first-content-production.md` (the two-phase rule), `/14 - research-first-blog-generation.md` (the diamond).
