...
- Policy this makes runnable: `lrp6-content-infrastructure/12 - ai-era-publishing-methodology.md` (it asserts the 5-6 year window and "low-detectability techniques" but names none — they are named here).
