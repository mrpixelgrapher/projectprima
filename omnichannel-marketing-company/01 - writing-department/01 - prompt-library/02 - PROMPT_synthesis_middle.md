...
- Policy: this is the unbuilt "middle layer" in `.\..\..\03 - architecture-governance\01 - content-infrastructure\14 - research-first-blog-generation.md`; it is what makes OUTPUT_CONTRACT gate 2 (originality) achievable.
